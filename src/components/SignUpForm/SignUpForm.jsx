        ...
        return (
            <div>
                <div className="team-logo">
                    <img src="https://github.com/ThiaCH/Project-3-Geekery/blob/main/assets/Geekery-League-Logo.png?raw=true" alt="Geekery League Logo" style={{ width: '400px', height: '150px' }} />
                </div>
